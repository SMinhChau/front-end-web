...
const GroupEvaluation = () => {
    ...
    const getTranscriptsSummaryBhyStudentId = (_id: number) => {
        ...
        ).then((result) => console.log("resulgetTranscriptsSummary -> ", result)
    ...
    const handlerSubmitTranscript = () => {
        ...
        transcriptService
            ...
            .then((result) => {
                showMessage("Chấm điểm thành công", 5000)
                console.log("postTranscripts => ", result);
                ...
                <Col span={15} style={{ backgroundColor: "#ffff" }} className={cls("transcript-col")}>
                    <Spin spinning={loadingTranscript}>
                        ...
                        <Row justify={"space-between"} style={{
                            ...
                            <Col> <Text strong type="danger" className={cls('title_point')}>Điểm trung bình</Text></Col>
                        </Row>
